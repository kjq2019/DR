...
SAVED_MODEL_NAME = 'D:/Diabetic_Retinopathy/effnet_B0.h5'
...
# effnet = efn.EfficientNetB0(input_shape=(SIZE, SIZE, 3), weights='imagenet', include_top=False)
#
...
base_model = resnet((SIZE, SIZE, 3), weights='imagenet', include_top=False)
model = Sequential()
...
csv_logger = CSVLogger(filename='D:/Diabetic_Retinopathy/reg_training_log.csv', separator=',', append=True)
